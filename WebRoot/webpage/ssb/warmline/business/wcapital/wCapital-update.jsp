 ...
 <body>
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
						     	 <input id="orderNumber" name="orderNumber" type="text" style="width: 150px" class="inputxt"  value='${wCapitalPage.orderNumber}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="orderId" name="orderId" type="text" style="width: 150px" class="inputxt"  value='${wCapitalPage.orderId}'>
							<span class="Validform_checktip"></span>
