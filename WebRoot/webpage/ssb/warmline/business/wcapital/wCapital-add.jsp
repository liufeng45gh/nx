...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="wCapitalController.do?doAdd" tiptype="1" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				...
				<tr>
					...
					<td class="value">
							   <input id="tradeTime" name="tradeTime" type="text" style="width: 150px" 
...
>    
				...
				<tr>
					...
					<td class="value">
					     	 <input id="amout" name="amout" type="text" style="width: 150px" class="inputxt" >
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
							   <input id="examineTime" name="examineTime" type="text" style="width: 150px" 
					      						class="Wdate" onClick="WdatePicker()"
>    
							<span class="Validform_checktip"></span>
					...
					<td class="value">
					     	 <input id="examineName" name="examineName" type="text" style="width: 150px" class="inputxt" >
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
							   <input id="approvalTime" name="approvalTime" type="text" style="width: 150px" 
					      						class="Wdate" onClick="WdatePicker()"
>    
							<span class="Validform_checktip"></span>
					...
					<td class="value">
					     	 <input id="approvalName" name="approvalName" type="text" style="width: 150px" class="inputxt" >
							<span class="Validform_checktip"></span>
