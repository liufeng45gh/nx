...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="wHelpMessageController.do?doAdd" tiptype="1" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				<!-- <tr>
					...
					<td class="value">
					     	 <input id="seekHelpPeopleId" name="seekHelpPeopleId" type="text" style="width: 150px" class="inputxt" >
							<span class="Validform_checktip"></span>
							<label class="Validform_label" style="display: none;">求助人id</label>
						</td>
				</tr>
				<tr>
					<td align="right">
					...
					<td class="value">
					     	 <input id="seekHelpPeople" name="seekHelpPeople" type="text" style="width: 150px" class="inputxt" >
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="helpPeopleId" name="helpPeopleId" type="text" style="width: 150px" class="inputxt" >
							<span class="Validform_checktip"></span>
							<label class="Validform_label" style="display: none;">帮助人id</label>
						</td>
				</tr>
				<tr>
					<td align="right">
					...
					<td class="value">
					     	 <input id="helpPeople" name="helpPeople" type="text" style="width: 150px" class="inputxt" >
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
							  <t:dictSelect field="readingState" type="list"
									typeGroupCode="messaState" defaultVal="${wHelpMessagePage.readingState}" hasLabel="false"  title="阅读状态 "></t:dictSelect>     
							<span class="Validform_checktip"></span>
							<label class="Validform_label" style="display: none;">消息状态  </label>
						</td>
				</tr>
				 --%>
				<%-- <tr>
