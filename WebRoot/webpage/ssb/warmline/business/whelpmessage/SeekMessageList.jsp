...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="wHelpMessageList" checkbox="false" fitColumns="true" title="求助消息" actionUrl="wHelpMessageController.do?seekMessageDatagrid" idField="id" fit="true" queryMode="group">
