...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="wHelpMessageList" checkbox="false" fitColumns="true" title="帮助消息" actionUrl="wHelpMessageController.do?hellpMessageDatagrid" idField="id" fit="true" queryMode="group">
   <t:dgCol title="id"  field="id"  hidden="true"  queryMode="group"  width="120"></t:dgCol>
   <t:dgCol title="求助人id"  field="seekHelpPeopleId" hidden="true"    queryMode="group"  width="120"></t:dgCol>
   <t:dgCol title="求助人"  field="seekHelpPeople"    queryMode="group"  width="120"></t:dgCol>
   <t:dgCol title="帮助人id"  field="helpPeopleId"  hidden="true"   queryMode="group"  width="120"></t:dgCol>
   <t:dgCol title="帮助人"  field="helpPeople"    queryMode="group"  width="120"></t:dgCol>
   ...
   <t:dgCol title="消息类型 " hidden="true"  field="messageType"  dictionary="messageTyp"  queryMode="group"  width="120"></t:dgCol>
   <t:dgCol title="阅读状态 "  field="readingState"   dictionary="readingSta" queryMode="group"  width="120"></t:dgCol>
  <%-- <t:dgCol title="操作" field="opt" width="100"></t:dgCol>
   ...
   <t:dgToolBar title="编辑" icon="icon-edit" url="wHelpMessageController.do?goUpdate" funname="update"></t:dgToolBar>
