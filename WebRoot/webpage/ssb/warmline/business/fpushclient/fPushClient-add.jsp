...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="fPushClientController.do?doAdd" tiptype="1" >
...
>    
				...
				<tr>
					...
					<td class="value">
					     	 <input id="token" name="token" type="text" style="width: 150px" class="inputxt" >
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="devicetoken" name="devicetoken" type="text" style="width: 150px" class="inputxt" >
							<span class="Validform_checktip"></span>
