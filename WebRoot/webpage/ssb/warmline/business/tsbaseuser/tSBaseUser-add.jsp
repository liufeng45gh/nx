...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tSBaseUserController.do?doAdd" tiptype="1" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					...
					<td class="value">
					     	 <input id="activitisync" name="activitisync" type="text" style="width: 150px" class="inputxt" >
				...
				<tr>
					...
					<td class="value">
					     	 <input id="browser" name="browser" type="text" style="width: 150px" class="inputxt" >
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
						  	 <textarea style="width:600px;" class="inputxt" rows="6" id="signature" name="signature"></textarea>
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="userkey" name="userkey" type="text" style="width: 150px" class="inputxt" >
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="deleteFlag" name="deleteFlag" type="text" style="width: 150px" class="inputxt" >
							<span class="Validform_checktip"></span>
