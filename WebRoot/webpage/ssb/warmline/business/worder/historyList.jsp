...
<%@include file="/context/mytags.jsp"%>
   <t:datagrid name="historyList" checkbox="false" fitColumns="true" title="历史订单" actionUrl="wOrderController.do?orderDatagrid"
   ...
   <t:dgCol title="求助类型"  field="seekStatus" query="true"  dictionary="seekstatus" queryMode="single"  ></t:dgCol>
  	<t:dgCol title="订单状态"  field="orderStatus" query="true"  dictionary="orderstatu"  queryMode="single"  ></t:dgCol>
