...
<t:datagrid name="userList" title="虚拟用户" actionUrl="userController.do?fictitiousNameDatagrid" 
	...
	<t:dgCol title="头像"  field="headPortrait"  image="true" imageSize="80,80"  queryMode="group"  width="100"></t:dgCol>
	...
	<c:if test="${userKey == null}">
		<t:dgToolBar title="用户录入" langArg="common.user" icon="icon-add" url="userController.do?addorupdate2" funname="add"></t:dgToolBar>
	</c:if>
	<t:dgToolBar title="用户编辑" langArg="common.user" icon="icon-edit" url="userController.do?addorupdate2" funname="update"></t:dgToolBar>
