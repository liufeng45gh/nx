...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table"   action="userController.do?saveUser3">
	...
	<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
		...
		<tr>
			...
			<td class="value" nowrap>
                ...
                <t:choose hiddenName="roleid" hiddenid="id" url="userController.do?generalRoles" name="roleList"
            ...
            <td align="right"><label class="Validform_label"> <t:mutiLang langKey="代理区域"/>: </label></td>
			<td class="value" nowrap>
        ...
        <!-- 身份类型  身份证-->		
        <tr>
			<td align="right" nowrap> <label class="Validform_label"> 证件类型：</label></td>
			<td class="value">
			<select name="documentType" id="documentType" atype="*">
        	...
        	<td align="right" nowrap><label class="Validform_label">  <t:mutiLang langKey="证件号"/>: </label></td>
			<td class="value">
