...
<t:datagrid name="userList3" title="用户管理" actionUrl="userController.do?generalDatagrId" 
    fit="true" fitColumns="false" idField="id" queryMode="group" sortName="id" sortOrder="desc" >
	<t:dgCol title="common.id" field="id" hidden="true"></t:dgCol>
	<t:dgCol title="昵称" sortable="false" field="userName" query="true" width="100"></t:dgCol>
	...
	<t:dgCol title="真实姓名" field="realName" query="false" width="100"></t:dgCol>
	...
	<t:dgCol title="年龄"  field="age"    queryMode="group"  width="40"></t:dgCol>
	<t:dgCol title="证件类型"  field="documentType"    queryMode="group"  width="60"></t:dgCol>
	<t:dgCol title="证件号"  field="identificationNumber"    queryMode="group"  width="140"></t:dgCol>
	<t:dgCol title="手机号"  field="phone"    queryMode="group"   width="90"></t:dgCol>
	...
	<t:dgCol title="用户类别"  field="userType"  dictionary="userType"   queryMode="group"  width="80"></t:dgCol>
	...
	<t:dgToolBar title="用户录入" langArg="common.user" icon="icon-add" url="userController.do?addorupdate3" width="800" funname="add"></t:dgToolBar>
	<t:dgToolBar title="用户编辑" langArg="common.user" icon="icon-edit" url="userController.do?addorupdate3" width="800" funname="update"></t:dgToolBar>
